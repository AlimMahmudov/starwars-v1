        ...
        <div className={scss.content}>
          <div className={scss.text}>
            ...
            <p>
              ...
              &quot;Звездных войн&quot;. Трейлер показывает масштабные битвы на
              разных планетах, таких как Хот, Эндор, Татуин, и включает как
              наземные сражения, так и космические битвы с участием звездных
              истребителей.
            </p>
